...
class scribeClient implements \Scribe\scribeIf {
  ...
  {
    $args = new \Scribe\scribe_Log_args();
  ...
  public function recv_Log()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Scribe\scribe_Log_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Scribe\scribe_Log_result();
